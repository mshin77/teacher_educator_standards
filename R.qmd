...
The website contains outputs and code used to analyze text data in Garcia et al. (in press). Reproducible materials are also posted at the [Center for Open Science](https://doi.org/10.17605/OSF.IO/23PDM).
